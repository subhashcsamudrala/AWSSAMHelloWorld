...
```bash
FoodOrder$ sam logs -n StockCheckerFunction --stack-name FoodOrder --tail
```
...
```bash
FoodOrder$ dotnet test tests/StockChecker.Test
```
...
```bash
aws cloudformation delete-stack --stack-name FoodOrder
```
